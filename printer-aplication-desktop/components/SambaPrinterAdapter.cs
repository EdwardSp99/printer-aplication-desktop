...
{
    public class SambaPrinterAdapter : IPrinter
    {
        private SambaPrinter printer;
        private EPSON elementDataPrinter;

        public SambaPrinterAdapter(string tempFileBasePath, string filePath)
        {
            printer = new SambaPrinter(tempFileBasePath, filePath);
        }
